...
import { buscarCitaPorId, renderConsultaCitas, generarPDFCitas, generarPDFMiCita} from "../controllers/citaController.js";
...
router.get('/generarPDFMiCita/:id', setNoCacheHeaders, verificarAutenticacion, verificarRol("Usuario general"), generarPDFMiCita);
